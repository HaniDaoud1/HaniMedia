...
var Menu = (props) => {
  ...
  const isUsingKeyboardRef = React35.useRef(false);
  ...
  return (0, import_jsx_runtime15.jsx)(Root2, { ...popperScope, children: (0, import_jsx_runtime15.jsx)(
    MenuProvider,
    {
      ...
      children: (0, import_jsx_runtime15.jsx)(
        ...
        {
          scope: __scopeMenu,
          onClose: React35.useCallback(() => handleOpenChange(false), [handleOpenChange]),
          isUsingKeyboardRef,
          dir: direction,
          modal,
          children
...
var MenuAnchor = React35.forwardRef(
  (props, forwardedRef) => {
...
var MenuContent = React35.forwardRef(
  (props, forwardedRef) => {
...
var MenuRootContentModal = React35.forwardRef(
  (props, forwardedRef) => {
    const context = useMenuContext(CONTENT_NAME2, props.__scopeMenu);
...
var MenuRootContentNonModal = React35.forwardRef((props, forwardedRef) => {
  const context = useMenuContext(CONTENT_NAME2, props.__scopeMenu);
  return (0, import_jsx_runtime15.jsx)(
    MenuContentImpl,
    {
...
var MenuContentImpl = React35.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeMenu,
      loop = false,
    ...
    const [currentItemId, setCurrentItemId] = React35.useState(null);
    const contentRef = React35.useRef(null);
    const composedRefs = useComposedRefs(forwardedRef, contentRef, context.onContentChange);
    const timerRef = React35.useRef(0);
    const searchRef = React35.useRef("");
    const pointerGraceTimerRef = React35.useRef(0);
    const pointerGraceIntentRef = React35.useRef(null);
    const pointerDirRef = React35.useRef("right");
    const lastPointerXRef = React35.useRef(0);
    const ScrollLockWrapper = disableOutsideScroll ? Combination_default : React35.Fragment;
    ...
    useFocusGuards();
    const isPointerMovingToSubmenu = React35.useCallback((event) => {
      var _a, _b;
    ...
    return (0, import_jsx_runtime15.jsx)(
      MenuContentProvider,
      {
        scope: __scopeMenu,
        searchRef,
        onItemEnter: React35.useCallback(
          (event) => {
            if (isPointerMovingToSubmenu(event)) event.preventDefault();
          },
          [isPointerMovingToSubmenu]
        ),
        onItemLeave: React35.useCallback(
          (event) => {
            var _a;
        ...
        onPointerGraceIntentChange: React35.useCallback((intent) => {
...
var MenuGroup = React35.forwardRef(
  (props, forwardedRef) => {
...
var MenuLabel = React35.forwardRef(
  (props, forwardedRef) => {
...
var MenuItemImpl = React35.forwardRef(
  (props, forwardedRef) => {
    ...
    const [textContent, setTextContent] = React35.useState("");
    React35.useEffect(() => {
      const menuItem = ref.current;
      if (menuItem) {
...
var MenuCheckboxItem = React35.forwardRef(
  (props, forwardedRef) => {
...
var MenuRadioGroup = React35.forwardRef(
  (props, forwardedRef) => {
...
var MenuRadioItem = React35.forwardRef(
  (props, forwardedRef) => {
...
var MenuItemIndicator = React35.forwardRef(
  (props, forwardedRef) => {
...
var MenuSeparator = React35.forwardRef(
  (props, forwardedRef) => {
...
var MenuArrow = React35.forwardRef(
  (props, forwardedRef) => {
...
var MenuSubTrigger = React35.forwardRef(
  (props, forwardedRef) => {
    const context = useMenuContext(SUB_TRIGGER_NAME, props.__scopeMenu);
    const rootContext = useMenuRootContext(SUB_TRIGGER_NAME, props.__scopeMenu);
    const subContext = useMenuSubContext(SUB_TRIGGER_NAME, props.__scopeMenu);
    const contentContext = useMenuContentContext(SUB_TRIGGER_NAME, props.__scopeMenu);
    const openTimerRef = React35.useRef(null);
    const { pointerGraceTimerRef, onPointerGraceIntentChange } = contentContext;
    const scope = { __scopeMenu: props.__scopeMenu };
    const clearOpenTimer = React35.useCallback(() => {
      if (openTimerRef.current) window.clearTimeout(openTimerRef.current);
      openTimerRef.current = null;
    }, []);
    React35.useEffect(() => clearOpenTimer, [clearOpenTimer]);
    React35.useEffect(() => {
...
var MenuSubContent = React35.forwardRef(
  (props, forwardedRef) => {
    const portalContext = usePortalContext(CONTENT_NAME2, props.__scopeMenu);
...
var DropdownMenuTrigger = React36.forwardRef(
  (props, forwardedRef) => {
...
var DropdownMenuContent = React36.forwardRef(
  (props, forwardedRef) => {
...
var DropdownMenuGroup = React36.forwardRef(
  (props, forwardedRef) => {
...
var DropdownMenuLabel = React36.forwardRef(
  (props, forwardedRef) => {
...
var DropdownMenuRadioGroup = React36.forwardRef((props, forwardedRef) => {
...
var DropdownMenuItemIndicator = React36.forwardRef((props, forwardedRef) => {
...
var DropdownMenuSeparator = React36.forwardRef((props, forwardedRef) => {
...
var DropdownMenuArrow = React36.forwardRef(
  (props, forwardedRef) => {
