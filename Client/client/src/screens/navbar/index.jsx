...
const dispatch=useDispatch();
  ...
  return (
    <div className='h-20 bg-green-950 flex flex-row justify-between items-center '>
        ...
        {user ? (<a href="/home"><div className='m-4 hover:cursor-pointer ' ><h1 className='text-2xl font-bold sm:ml-8 sm:text-4xl text-white hover:text-gray-200 '>HaniMedia</h1></div></a>):(<div className='m-4 hover:cursor-pointer ' ><h1 className='text-2xl font-bold sm:ml-8 sm:text-4xl text-white hover:text-gray-200 '>HaniMedia</h1></div>)}
        ...
        <div id='message' className=' flex flex-row items-center max-[450px]:mx-4 mx-8'>
            ...
            {mode === 'blanc' ? (
  <Moon className="hover:text-slate-900 rounded-full ml-3 text-white hover:cursor-pointer max-[420px]:mx-1 text-sm" onClick={ChangeMode} />
) : (
  <Sun className="hover:text-slate-400 text-white hover:cursor-pointer ml-3 rounded-full max-[420px]:mx-1" onClick={ChangeMode} />
)}
            {user ? (<DropdownMenu>
